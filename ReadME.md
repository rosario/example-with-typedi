Dependency Injection in Typescript with and without `typedi`
...
Without using `typedi` the output generated by Typescript has become more compact and readable. It not far away from the original Typescript itself after it has been stripped down of types. 
